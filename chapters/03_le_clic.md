...
L'employée tape son adresse email. Elle tape son mot de passe. Elle clique sur **Se connecter**.
...
L'employée a entré ses identifiants sur une page qu'elle ne contrôle pas. Ces identifiants ont été envoyés en temps réel à un serveur distant. Pas à Microsoft.

La redirection vers Outlook réel est intentionnelle. Elle évite que l'employée se pose des questions. Du point de vue de l'utilisatrice, rien d'anormal ne s'est produit. Elle est connectée. Tout fonctionne.
...
L'employée utilise `MdP@2020!` sur LinkedIn aussi. Et sur son compte Gmail personnel.

...
Le comptable externe rappelle pour confirmer le changement de RIB. Il tombe sur la directrice administrative, qui n'a pas été informée d'un changement de coordonnées bancaires. Elles vérifient ensemble avec Sarah. Sarah n'a pas envoyé cet email.
...
- Un email envoyé depuis le compte de Sarah à 10h02.
...
Personne n'a vu d'anomalie pendant trois jours parce que personne ne regardait. Pas d'alerte sur la connexion depuis un pays inhabituel. Pas de notification à Sarah d'une nouvelle connexion sur son compte. Pas de surveillance des règles de transfert créées dans les boîtes des collaborateurs.
